<script>
	...
	import RodeurDialog from '$lib/game/Map/RodeurDialog.svelte';
...
<div class="maxContent">
	<div
		...
		out:blur={{ duration: mooveSpeed * 500 }}
	>
		<!-- {#if myRoom} -->
		{#if isFixed}
			<div
	...
	{#if user.hero == 'Rodeur'}
		<RodeurDialog {user} active={dialogActive == 'dialog_power'} />
	{/if}
